...
1. ✅ Receives a **GET** request at the **/api/surveys** route
...
1. ✅ Returns **404** error if the API endpoint does not exists
2. ✅ Returns **403** error if the requester is not a valid user
